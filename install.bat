REM Installs Ofb's IntelliJ configs into your user configs.
@echo off
echo Installing Ofb IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'OfbJava' or 'OfbAndroid'.
exit /b
